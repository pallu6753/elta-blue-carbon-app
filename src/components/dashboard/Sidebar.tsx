    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <a
          ...
          className={cn(
            'flex items-center justify-center w-full h-16 text-gray-500 transition-colors duration-200 hover:bg-muted hover:text-primary relative',
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-16 bg-card shadow-xl fixed top-0 left-0 h-full z-40">
       <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Link
              href="/"
              onClick={logout}
              className="h-16 flex items-center justify-center border-b hover:bg-muted transition-colors duration-200"
              aria-label="Homepage"
            >
        ...
        <div className="mt-auto py-2 border-t">
           <Tooltip>
            <TooltipTrigger asChild>
                ...
                className="flex items-center justify-center w-full h-16 text-gray-500 transition-colors duration-200 hover:bg-muted"
                >
